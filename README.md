...
Тестовые данные - в соответствии со [схемой](https://github.com/notafavor/test-cases/blob/main/case_1.jpg), изображенной в тз. Генерируются виды отходов, организации, хранилища, локации, дороги, а также их связи.
Для того, чтобы сгенерировать тестовые данные, нужно:
- войти в cli контейнера: ```sudo docker exec -it atom_eco_app bash```
- запустить скрипт командой: ```python3 testdata_generator.py```

login: username / password вида company1@example.com / company1 или
storage2@example.com / storage2. Где цифра - номер организации/хранилища по схеме.

Удаление тестовых данных командой: ```sudo docker compose down --volumes```
